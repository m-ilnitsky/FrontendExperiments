...
(function () {
    var mixinForSorting = {
                ...
                if (this.sorting.fieldType === "date") {
                    if (this.sorting.isAscending) {
                        return this.sorting.list.sort((e1, e2) =>
                            (new Date(this.getField(e1))).valueOf() - (new Date(this.getField(e2))).valueOf());
                    } else {
                        return this.sorting.list.sort((e1, e2) =>
                            (new Date(this.getField(e2))).valueOf() - (new Date(this.getField(e1))).valueOf());
                    }
                }
        ...
        methods: {
            getListElementField(listElement) {
                ...
                if (!this.sorting.fieldName.includes(".")) {
            ...
            getField: function (listElement) {
                if (this.sorting.fieldFunction === null) {
                    return this.getListElementField(listElement);
                }

                return this.sorting.fieldFunction(this.getListElementField(listElement));
            },
