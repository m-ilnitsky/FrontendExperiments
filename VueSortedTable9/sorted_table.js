...
(function () {
    ...
    Vue.directive("sort-by-column", {
        bind(el, binding, vNode) {
            var fieldFunction = null;

            if (binding.value.fieldFunction !== undefined) {
                fieldFunction = binding.value.fieldFunction;
            }
            ...
            var sortingIcon = $("<i class='fa sort-by-column' aria-hidden='true'></i>");
            ...
            $(el).append(sortingIcon);

            $(el).addClass("hand-cursor");
